...
def generate_planning_problem(problem, distance_evaluator, objectives_to_sample=None, mode='prunning', step_num=0, out_file_name='out.txt', voi_evaluator=None):
	...
	return call_planner(problem_name, out_file_name)
	

	


def call_planner(problem_name, out_file_name):
	import subprocess
